...
*/
DROP DATABASE IF EXISTS cs_flowable;
CREATE DATABASE IF NOT EXISTS cs_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS cs;
CREATE DATABASE IF NOT EXISTS cs DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用cs管理系统', '2017-01-11 08:53:20', '1');
