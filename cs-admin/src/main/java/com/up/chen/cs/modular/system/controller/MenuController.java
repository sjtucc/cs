...
import com.up.chen.cs.core.common.constant.dictmap.MenuDict;
...
import com.up.chen.cs.modular.system.service.IMenuService;
import com.up.chen.cs.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new CsException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new CsException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
