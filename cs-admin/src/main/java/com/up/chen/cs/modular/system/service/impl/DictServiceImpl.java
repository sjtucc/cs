...
import com.up.chen.cs.modular.system.dao.DictMapper;
import com.up.chen.cs.modular.system.model.Dict;
import com.up.chen.cs.modular.system.service.IDictService;
...
import static com.up.chen.cs.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new CsException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new CsException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
