...
import com.up.chen.cs.generator.engine.SimpleTemplateEngine;
import com.up.chen.cs.generator.engine.base.CsTemplateEngine;
import com.up.chen.cs.generator.engine.config.ContextConfig;
import com.up.chen.cs.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doCsGeneration() {
        CsTemplateEngine csTemplateEngine = new SimpleTemplateEngine();
        csTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        csTemplateEngine.setSqlConfig(sqlConfig);
        csTemplateEngine.setTableInfo(tableInfo);
        csTemplateEngine.start();
    }
}
