...
public class ContextConfig {
    ...
    private String templatePrefixPath = "csTemplate/advanced";
    private String projectPath = "D:\\idea\\mypros\\cs";//模板输出的项目目录
    ...
    private String proPackage = "com.up.chen.cs.admin";
    private String coreBasePackage = "com.up.chen.cs.core";
    private String modelPackageName = "com.up.chen.cs.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.up.chen.cs.modular.system.dao";    //model的dao
